...
export default () => (
    <Layout>
        ...
        <article className="u-measure">
            ...
            <ul>
                <li>Led a four-person distributed design team in developing a new HealthCare.gov eligibility application, providing a streamlined experience to help over 7.5 million applicants get health coverage with greater ease and peace of mind. Responsible for overall vision, planning the design roadmap, setting milestones, and distributing ownership of work. Collaborated with product and engineering leads to shape product roadmap. Identified, assessed and addressed project risks with company leadership on a weekly basis.</li>
                <li>Strengthened collaboration with our government partners at the Centers for Medicare & Medicaid Services (CMS) by serving as the voice of design in meetings with stakeholders. Organized weekly design syncs with CMS design leadership to share progress and gather ongoing feedback. Developed documentation standards for requirements/user flows to enforce alignment and reach consensus between CMS stakeholders and internal teams.</li>
                <li>Led discovery research composed of competitive analysis, design audits, stakeholder interviews and user research to uncover applicant needs in eligibility-based services. Distilled findings into a set of design principles used to identify key priorities and guide feature development. Advocated for more efficient research practices with CMS research partners, i.e. targeted lightweight testing sprints, over end-to-end testing sessions.</li>
                <li>Facilitated regular spaces for design team to present and critique work, explore ideas and develop strategies. Held weekly 1:1s with direct reports to provide regular support and feedback, coaching, and opportunities for growth. Improved internal team processes, including: increasing usefulness of retrospectives, overhauling onboarding to ramp up new team members, designing more effective interview processes, and developing a career development review process adopted by the broader design organization.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Advocated for collaborative design practices, and ran workshops and exercises to train team members on developing design systems and to improve communications between project managers, designers, and engineers.</li>
            ...
            <ul>
                ...
                <li>Led the product redesign of OpenCongress, a platform that allows users to track activity in the U.S. Congress. Produced a new logo, custom icons, and components library for the rebrand. Created  wireframes for user stories and design mocks for primary views. Conducted user research to understand needs of the core audience and identify improvements to existing features.</li>
            ...
            <ul>
                <li>Designed and built event websites for the nonprofit to raise awareness and increase community engagement. Implemented custom front-ends, event registration systems, CMS and payment integrations, facilitating over $200,000 in fundraising annually.</li>
            </ul>
